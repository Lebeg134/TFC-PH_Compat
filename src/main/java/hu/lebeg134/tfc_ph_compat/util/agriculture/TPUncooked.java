...
public enum TPUncooked {
    ...
    UNCOOKEDORANGEDUCKITEM(GRAIN, 4,3f,0f,0f,1f,0.75f,0.75f,0f,3.82f,1f,480),
    UNCOOKEDPEACHCOBBLERITEM(GRAIN, 4,1f,0f,0.5f,0f,0.25f,0f,0f,2.8f,1f,480),
    ...
    UNCOOKEDPEKINGDUCKITEM(GRAIN, 4,1.9f,0f,1f,0.25f,0f,1.25f,0f,2.1f,1f,480),
    ...
    UNCOOKEDRAISINCOOKIESITEM(GRAIN, 4,0.5f,0f,0.5f,0f,0.5f,0f,0f,2f,1f,480),
